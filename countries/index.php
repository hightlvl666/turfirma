...
<?$APPLICATION->IncludeComponent("bitrix:catalog", "strani", Array(
	"ACTION_VARIABLE" => "action",	// Название переменной, в которой передается действие
		...
		"IBLOCK_TYPE" => "all",	// Тип инфоблока
		"INCLUDE_SUBSECTIONS" => "Y",	// Показывать элементы подразделов раздела
		"INSTANT_RELOAD" => "N",	// Мгновенная фильтрация при включенном AJAX
		"LABEL_PROP" => "",	// Свойство меток товара
		"LAZY_LOAD" => "N",	// Показать кнопку ленивой загрузки Lazy Load
		"LINE_ELEMENT_COUNT" => "9",	// Количество элементов, выводимых в одной строке таблицы
		...
		"LIST_PRODUCT_ROW_VARIANTS" => "[{'VARIANT':'4','BIG_DATA':false}]",	// Вариант отображения товаров
